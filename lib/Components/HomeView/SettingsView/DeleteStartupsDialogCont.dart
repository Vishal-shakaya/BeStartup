...
//     try {
//       final resp =
//           await removeStartupStore.DeleteStartups(user_id: id);
...
//       final startups_resp =  await homeViewConnector.FetchUserStartups(user_id: user_id);
//       // print('startup response $startups_resp');
//       startup_ids = startups_resp['data']['user_ids'];
